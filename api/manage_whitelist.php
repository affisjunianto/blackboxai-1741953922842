...
$pageTitle = 'Manage API Whitelist';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verifyCSRFToken($_POST['csrf_token'])) {
        ...
        redirect('/api/manage_whitelist.php');
    }
    ...
    try {
        switch ($action) {
            case 'add':
                ...
                addIPToWhitelist($_SESSION['user_id'], $ipAddress, $description);
            ...
            case 'remove':
                ...
                if (removeIPFromWhitelist($_SESSION['user_id'], $ipId)) {
...
$whitelistedIPs = getUserWhitelistedIPs($_SESSION['user_id']);
?>

<div class="main-content">
    <div class="container-fluid">
        <h1 class="h3 mb-4">Manage API IP Whitelist</h1>
        ...
        <div class="card custom-card mt-4">
            ...
            <div class="card-body">
                <ol class="mb-0">
                    <li class="mb-2">Add the IP addresses that will be making API requests to the whitelist above.</li>
                    <li class="mb-2">You can whitelist up to 2 IP addresses for security purposes.</li>
                    <li class="mb-2">Only requests from whitelisted IPs will be allowed to access the API.</li>
